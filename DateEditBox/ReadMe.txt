========================================================================
		ActiveX Control DLL : dateeditbox
========================================================================

ControlWizard has created this project for your dateeditbox ActiveX Control
...
that make up your dateeditbox ActiveX Control DLL.
...
dateeditboxCtl.h
	This file contains the declaration of the CdateeditboxCtrl C++ class.

dateeditboxCtl.cpp
	This file contains the implementation of the CdateeditboxCtrl C++ class.

dateeditboxPpg.h
	This file contains the declaration of the CdateeditboxPropPage C++ class.

dateeditboxPpg.cpp
	This file contains the implementation of the CdateeditboxPropPage C++ class.

dateeditboxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CdateeditboxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file dateeditbox.rc.
